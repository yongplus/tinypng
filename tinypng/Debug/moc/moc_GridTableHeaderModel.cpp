...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GridTableHeaderModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GridTableHeaderModel_t qt_meta_stringdata_GridTableHeaderModel = {
    {
QT_MOC_LITERAL(0, 0, 20) // "GridTableHeaderModel"
...
QT_INIT_METAOBJECT const QMetaObject GridTableHeaderModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractTableModel::staticMetaObject>(),
    qt_meta_stringdata_GridTableHeaderModel.data,
